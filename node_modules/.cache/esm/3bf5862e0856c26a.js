let Joi,Projectbrucella;_085‍.x([["default",()=>_085‍.o]]);_085‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_085‍.w("../Model/Projectbrucella",[["default",["Projectbrucella"],function(v){Projectbrucella=v}]]);
...
const ProjectbrucellaController = {
  ...
  async updateProjectbrucella(req, res, next) {
    ...
    const { name, workOder, noofSample, requiredTest, sampleType, date, lab } =
      req.body;
    _085‍.g.console.log(req.body, "reqbody");
    let product;
    try {
      ...
      _085‍.g.console.log(product, "product");
      _085‍.g.console.log(req.params.id, "id");
    } catch (error) {
      return next(error);
    }
    res.json(product);
...
_085‍.d(ProjectbrucellaController);
